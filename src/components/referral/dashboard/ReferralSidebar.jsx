...
import networksvg from "src/assets/img/referral/network.svg";
...
const SidebarContent = ({ onClose, user, ...rest }) => {
  ...
  return (
    ...
    >
      ...
      <button
        className="flex gap-x-2 mt-28 lg:mt-96 w-[90%] md:w-56  text-white text-lg mx-4 items-center rounded-md  hover:bg-primary font-semibold p-4"
        onClick={logout}
      >
        <IoIosLogOut className="w-6 h-6 font-semibold" />
        <p>Logout</p>
      </button>
    </Box>
  );
...
const MobileNav = ({ onOpen, user, ...rest }) => {
  ...
  return (
    ...
    >
      ...
      <h1 className="text-white font-bold text-2xl">Referral</h1>
